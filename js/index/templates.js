    ...
    return `
        <div class="relative border rounded-md shadow-lg px-2 py-5 flex flex-col items-center space-y-5">
            ...
            <div class="flex justify-center items-center">
                <button class="border px-4 py-2 bg-logoColor text-white" ${!course.hasActive ? 'disabled' : ''} onclick="${course.hasActive ? `openRequestCallback('course', '${course._id}')` : `showSnackbar('Please dont hack me!')`}">Request</button>
